 ...
 * @author rails
 */
public class frmContasAPagarAssistente extends javax.swing.JInternalFrame {
    ...
    private int contadorAssistente = 0;
    
    
    public void atualizarDados(Dados bd, Assistente aAuxiliar){
        this.bd = bd;
        this.aAuxiliar = aAuxiliar;
    }
    public frmContasAPagarAssistente() {
        initComponents();
    }
    ...
    private void cmdvizualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdvizualizarActionPerformed
        ...
        if(contadorAssistente > bd.retornaIndiceUltimoCadastroAssistente()){
            contadorAssistente--;
        }
        
        vizualizarContasAssistente(contadorAssistente);
        contadorAssistente++;
    ...
    public void vizualizarContasAssistente(int indice){
        ...
        txtvalorpagamento.setText(Double.toString(bd.getAssistentes().get(indice).getSalario()));
        
        double totalpagamento = 0;
        
        for(int i = 0; i < bd.getAssistentes().size(); i++){
            totalpagamento = totalpagamento + bd.getAssistentes().get(i).getSalario();
        }
