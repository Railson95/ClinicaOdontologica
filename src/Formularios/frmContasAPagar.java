 ...
 * @author rails
 */
public class frmContasAPagar extends javax.swing.JInternalFrame {
    ...
    private int contadorDentista, contadorSecretaria = 0;
    
    
    public void atualizarDados(Dados bd, Dentista den){
        this.bd = bd;
        this.den = den;
    }
    ...
    private void cmdvizualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdvizualizarActionPerformed
        ...
        if(contadorDentista > bd.retornaIndiceUltimoCadastro()){
            contadorDentista--;
        }
        
        vizualizarContasDentistas(contadorDentista);
        contadorDentista++;
    ...
    public void vizualizarContasDentistas(int indice){
        ...
        txtvalorpagamento.setText(Double.toString(bd.getDentistas().get(indice).getSalario()));
        
        double totalpagamento = 0;
        
        for(int i = 0; i < bd.getDentistas().size(); i++){
            totalpagamento = totalpagamento + bd.getDentistas().get(i).getSalario();
        }
    ...
    public void vizualizarContasSecretarias(int indice){
    ...
    public void vizualizarContasAssistentes(int indice){
